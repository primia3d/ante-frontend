...
export function EdgeForm({ isOpen, setIsOpen, onSubmit, mode, initialLabel = '' }: EdgeFormProps) {
      ...
      <DialogContent className="p-5">
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-5">
          <div className="relative">
            <Label className={cn('font-bold capitalize leading-7 text-custom-300')}>Edge Label</Label>
            <Textarea
