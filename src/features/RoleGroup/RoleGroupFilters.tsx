...
import { roleGroupSearchAtom } from './roleGroupAtom';

import { Input } from '@/components/Input';
// import { useGlobalSearch } from '@/hooks/useGlobalSearch';

export function RoleGroupFilters({ onSearch }: { onSearch: (searchQuery: string) => void }) {
  const [search, setSearch] = useAtom(roleGroupSearchAtom);
